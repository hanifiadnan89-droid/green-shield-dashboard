...
/** @deprecated Use isGoogleMapsEnabled */
export const isIntakeMapsEnabled = isGoogleMapsEnabled;
...
function loadScript() {
  ...
  loadPromise = new Promise((resolve, reject) => {
    ...
    const fail = (code, detail = '') => {
      ...
      console.error('[Maps]', code, detail || '');
      reject(err);
    };
...
export function useGoogleMapsLoader() {
  const [state, setState] = useState(() => {
    if (!getApiKey()) return { status: 'no_key',  errorCode: 'no_key', errorDetail: '' };
    if (mapsReady())   return { status: 'ready',   errorCode: null,     errorDetail: '' };
...
/** @deprecated Use useGoogleMapsLoader */
export const useIntakeGoogleMapsLoader = useGoogleMapsLoader;
